...
import { PenTool, Scale, Shield } from 'lucide-react';
            ...
            <section className="relative min-h-[60vh] py-24 flex flex-col items-center justify-center bg-black z-20 text-white px-6">
                ...
                >
                    <motion.div
                        ...
                        className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-[#C67B5C] shadow-[0_0_30px_rgba(198,123,92,0.18)]"
                    >
                        <Scale size={24} />
                    </motion.div>
                    <div className="h-px w-20 bg-gradient-to-r from-[#C67B5C] to-transparent" />
                </motion.div>
                <motion.div
                ...
                <div className="relative z-10 -mt-[50vh] pb-24 max-w-5xl mx-auto px-6">
                    ...
                    >
                        <div className="flex items-center justify-center gap-4">
                            <div className="h-px w-16 bg-gradient-to-r from-transparent to-[#7B8C4E]" />
                            <motion.div
                                animate={{ y: [0, -4, 0], rotate: [0, -6, 0, 6, 0] }}
                                transition={{ duration: 5.2, repeat: Infinity, ease: 'easeInOut' }}
                                className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-[#7B8C4E] shadow-[0_0_30px_rgba(123,140,78,0.18)]"
                            >
                                <PenTool size={22} />
                            </motion.div>
                            <div className="h-px w-16 bg-gradient-to-l from-transparent to-[#7B8C4E]" />
                        </div>
                ...
                >
                    <div className="text-center mb-12">
                        <motion.div
                            ...
                            className="mx-auto mb-8 flex h-14 w-14 items-center justify-center rounded-2xl border border-[#DDB79B] bg-white/60 text-[#C67B5C] shadow-sm"
                        >
                            <Shield size={24} />
                        </motion.div>
