...
const homepageGuidePanels = [
    {
        ...
        body: '先理解網站的限制與基本原則，再往下閱讀還原筆記與共構內容。',
    },
    {
        id: 'ethics',
        label: '倫理',
        ...
        body: '討論聚焦制度與職務，避免人身攻擊、洩漏個資或將未公開資訊帶出站外。',
    },
    {
        id: 'workflow',
        label: '運作',
        ...
        body: '從觀庭、彙整、核對到公開共構，網站內容以逐步整理、持續更新的方式前進。',
    },
    {
        id: 'what-we-do',
        label: '平台在做什麼',
        ...
        body: '整合資訊、降低閱讀門檻，讓更多人能從具備脈絡的還原筆記理解案件。',
    },
    {
        id: 'problems',
        label: '問題',
        ...
        body: '對抗資訊紛亂、單一詮釋壟斷與彼此無法傾聽的困境，為討論建立較穩定的基底。',
    },
];
...
export default function Home() {
    ...
    const activeHomeGuidePanel = homepageGuidePanels.find((panel) => panel.id === homeGuidePanel) ?? homepageGuidePanels[0];
