...
function SectionMark({ en, zh }: { en: string; zh: string }) {
    return (
...
export default function ProjectIntentionPrototypePage() {
    return (
        <div className="min-h-screen bg-[#FBF7F0]">
            <SubpageHeader variant="dark" />

            <section className="relative overflow-hidden bg-[#0A0A0A] pt-20 text-white">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(198,123,92,0.16),transparent_30%),radial-gradient(circle_at_bottom_right,rgba(123,140,78,0.12),transparent_34%)]" />
                ...
                <div className="relative z-10 -mt-[52vh] max-w-5xl mx-auto px-6 pb-[10vh]">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 text-left">
                            ...
                            <div className="md:col-span-10 space-y-7 text-xl md:text-2xl leading-[2] font-serif italic text-[#E6DED4]">
            ...
            <section className="relative overflow-hidden bg-black text-white py-20 md:py-28">
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                    ...
                    <motion.p
                        ...
                        className="text-base md:text-xl leading-[1.95] text-gray-300 max-w-4xl mx-auto"
                    >
                    ...
                    <motion.p
                        ...
                        className="mt-8 text-xl md:text-2xl font-black tracking-[0.24em] text-[#F0D8B6]"
                    >
                        讓事實成為第三方語言
                    </motion.p>
                    <motion.div
                    ...
                    <motion.p
                        ...
                        className="mt-8 text-3xl md:text-5xl font-black text-white"
                        style={serif}
                    >
                        「讓事實成為第三方語言」
                    </motion.p>
                    <motion.p
                        ...
                        className="mt-8 text-base md:text-lg text-gray-300 leading-[1.95] max-w-4xl mx-auto"
                    >
                ...
                <div className="max-w-6xl mx-auto px-6 space-y-14">
                    ...
                    >
                        <div className="lg:sticky lg:top-24">
                            <SectionMark en="Problems We Solve" zh="所以這個網站要解決的問題是" />
                        </div>
                    ...
                    >
                        <div className="grid grid-cols-1 lg:grid-cols-[0.88fr_1.12fr]">
                            <div className="px-8 py-10 md:px-10 md:py-12 bg-[radial-gradient(circle_at_top_left,rgba(198,123,92,0.18),transparent_42%),radial-gradient(circle_at_bottom_right,rgba(123,140,78,0.16),transparent_34%)]">
                                <SectionMark en="Workflow & Features" zh="我們團隊將透過" />
                                <div className="mt-8 space-y-4 text-[17px] md:text-[19px] leading-[1.95] text-[#E9DED3] font-medium">
                                    {workflowIntro.map((paragraph) => (
                                        <p key={paragraph}>{paragraph}</p>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="px-8 py-8 md:px-10 md:py-10 space-y-6">
                                {workflowStages.map((block, index) => (
                                    <motion.div
                                        key={block.title}
